...
echo "🚀 Starting ISP Framework Database Seeding..."
...
declare -a CUSTOMERS=(
    ...
    "Diana Miller:diana.miller@example.com:+1-555-0106:987 Cedar Ln:Philadelphia:PA:19101:USA"
    "Frank Davis:frank.davis@example.com:+1-555-0107:147 Birch Ct:San Antonio:TX:78201:USA"
    "Grace Taylor:grace.taylor@example.com:+1-555-0108:258 Spruce Way:San Diego:CA:92101:USA"
    "Henry Anderson:henry.anderson@example.com:+1-555-0109:369 Willow Blvd:Dallas:TX:75201:USA"
    "Ivy Thomas:ivy.thomas@example.com:+1-555-0110:741 Poplar St:San Jose:CA:95101:USA"
)
...
# 7. Create customer services (only if service templates were created)
...
# 8. Create sample invoices (let auto-creation handle billing accounts)
echo "8. Creating sample invoices..."
for i in {1..5}; do
    CUSTOMER_ID=$((i * 2))  # Use every other customer

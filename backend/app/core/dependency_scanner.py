...
class DependencyScanner:
    ...
    def run_pip_audit(self) -> Dict:
        ...
        try:
            cmd = ['pip-audit', '--format=json', '--requirement', self.requirements_file]
    ...
    def run_comprehensive_scan(self) -> Dict:
        ...
        for scanner_name, scanner_result in results['scanners'].items():
            if scanner_result.get('scan_successful'):
                if 'total_issues' in scanner_result:
                    ...
                    critical_count += len(issues_by_severity.get('high', []))  # Bandit high = critical
                ...
                if 'total_vulnerabilities' in scanner_result:
                    ...
                    vulns_by_severity = scanner_result.get('vulnerabilities_by_severity', {})
        ...
        results['summary'] = {
            ...
            'scan_successful': any(r.get('scan_successful') for r in results['scanners'].values())
        }

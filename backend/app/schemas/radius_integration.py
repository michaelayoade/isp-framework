...
class RadiusAuthResponse(BaseSchema):
    ...
    radius_attributes: Dict[str, Any] = Field(..., description="RADIUS attributes for enforcement")
...
class SessionInfo(BaseSchema):
    ...
    session_duration: Optional[int] = Field(0, description="Session duration in seconds")
...
class ServicePlanEnforcementResponse(BaseSchema):
    ...
    radius_attributes: Dict[str, Any] = Field(..., description="RADIUS enforcement attributes")
    bandwidth_limits: Optional[Dict[str, int]] = Field(None, description="Bandwidth limits")
    data_limits: Optional[Dict[str, int]] = Field(None, description="Data usage limits")
    session_limits: Optional[Dict[str, int]] = Field(None, description="Session time limits")
...
class UsageMonitoringRequest(BaseSchema):
    ...
    time_period: str = Field("daily", pattern="^(hourly|daily|weekly|monthly)$", description="Monitoring period")
...
class UsageMonitoringResponse(BaseSchema):
    ...
    usage_statistics: List[UsageStatistics] = Field(..., description="Usage statistics per customer")

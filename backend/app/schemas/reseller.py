...
class ResellerCreate(ResellerBase):
    ...
    password: str = Field(
        ...
        min_length=8,
        max_length=255,
        description="Password for reseller authentication",
    )
...
class ResellerResponse(ResellerBase):
    ...
    customer_count: Optional[int] = Field(
        default=0, description="Number of customers assigned to this reseller"
    )
    total_commission: Optional[Decimal] = Field(
        default=Decimal("0"), description="Total commission earned"
    )

...
class ServicePlanBase(BaseSchema):
    ...
    service_type: str = Field("internet", description="Service type: internet, voice, bundle, recurring, onetime")
    price: int = Field(..., gt=0, description="Price in smallest currency unit (e.g., kobo/cents)")
    ...
    download_speed: Optional[int] = Field(None, gt=0, description="Download speed in Mbps")

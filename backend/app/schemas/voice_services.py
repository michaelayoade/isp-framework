...
class VoiceServiceBase(BaseModel):
    ...
    features: Optional[List[str]] = Field(default_factory=list, description="Service features")
...
class VoiceServiceProvisioningRequest(BaseModel):
    ...
    features: Optional[List[str]] = Field(default_factory=list, description="Features to enable")

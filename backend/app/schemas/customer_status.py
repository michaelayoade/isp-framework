...
class CustomerStatusBase(BaseSchema):
    ...
    # Workflow properties
    allows_service_activation: bool = Field(True, description="Can services be activated in this status")
    allows_billing: bool = Field(True, description="Should billing continue in this status")

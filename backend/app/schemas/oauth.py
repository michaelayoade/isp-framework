...
class OAuthClientCreate(BaseModel):
    ...
    grant_types: str = Field(default="authorization_code,refresh_token", description="Supported grant types")
    scopes: str = Field(default="customer_portal,admin_portal,api", description="Allowed scopes")

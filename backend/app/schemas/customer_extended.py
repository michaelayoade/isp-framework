...
class CustomerBillingConfigCreate(BaseModel):
    ...
    late_fee_percentage: Decimal = Field(
        Decimal("0.00"), description="Late fee percentage"
    )
    ...
    default_discount_percentage: Decimal = Field(
        Decimal("0.00"), description="Default discount percentage"
    )
    loyalty_discount_eligible: bool = Field(
        True, description="Loyalty discount eligible"
    )
...
class CustomerExtendedCreate(BaseModel):
    ...
    company_registration: Optional[str] = Field(
        None, description="Company registration"
    )
    tax_id: Optional[str] = Field(None, description="Tax ID")
...
class CustomerExtendedUpdate(BaseModel):
    ...
    communication_method: Optional[str] = Field(
        None, description="Communication method"
    )

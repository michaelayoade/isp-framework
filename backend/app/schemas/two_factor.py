...
class TwoFactorStatusResponse(BaseSchema):
    ...
    verified_at: Optional[datetime] = Field(None, description="When 2FA was first verified")
    last_used: Optional[datetime] = Field(None, description="Last successful 2FA verification")
...
class TwoFactorSessionRequest(BaseSchema):
    """Request to create 2FA session"""
    username: str = Field(..., description="Username")
    password: str = Field(..., description="Password")


class TwoFactorSessionResponse(BaseSchema):
...
class TwoFactorSessionVerifyRequest(BaseSchema):
...
class TwoFactorDisableRequest(BaseSchema):
    ...
    verification_code: str = Field(..., description="Current 2FA code", min_length=6, max_length=6)

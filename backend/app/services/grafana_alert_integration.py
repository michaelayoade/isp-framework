...
class GrafanaAlertIntegrationService:
    ...
    async def get_alert_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            result = {
                ...
                'alert_effectiveness': await self._calculate_alert_effectiveness(last_7d)
            }
    ...
    async def _get_alert_statistics(self, last_24h: datetime, last_7d: datetime) -> Dict[str, Any]:
        """Get alert statistics."""

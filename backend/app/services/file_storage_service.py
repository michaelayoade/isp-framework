...
class MinIOService:
    ...
    def generate_presigned_download_url(
        self, bucket_name: str, object_key: str, filename: str, expires_in: int = 3600
    ) -> str:
...
class FileStorageService:
    ...
    async def get_download_url(self, file_id: int, expires_in: int = 3600) -> str:
    ...
    def get_file_info(self, file_id: int) -> Dict[str, Any]:
        ...
        return {"metadata": file_record, "storage_info": minio_info}

...
ISP_WEBHOOK_EVENTS = {
    ...
    "customer.created": {
        ...
        "payload_schema": {
            ...
            "required": ["customer_id", "customer_number", "name", "status", "created_at"]
        },
        "sample_payload": {
            "customer_id": 123,
    ...
    "invoice.created": {
        ...
        "payload_schema": {
            ...
            "required": ["invoice_id", "invoice_number", "customer_id", "amount", "due_date", "status"]
        },
        "sample_payload": {
            "invoice_id": 456,
    ...
    "invoice.overdue": {
        ...
        "payload_schema": {
            ...
            "required": ["invoice_id", "customer_id", "amount", "due_date", "days_overdue"]
        },
        "sample_payload": {
            "invoice_id": 456,
            "invoice_number": "INV-2024-001",
    ...
    "service.activated": {
        ...
        "payload_schema": {
            ...
            "required": ["service_id", "customer_id", "service_type", "activation_date"]
        },
        "sample_payload": {
            "service_id": 789,
            "customer_id": 123,
    ...
    "service.suspended": {
        ...
        "payload_schema": {
            ...
            "required": ["service_id", "customer_id", "suspension_reason", "suspended_at"]
        },
        "sample_payload": {
            "service_id": 789,
            "customer_id": 123,
    ...
    "service.terminated": {
        ...
        "payload_schema": {
            ...
            "required": ["service_id", "customer_id", "termination_reason", "terminated_at"]
        },
        "sample_payload": {
            "service_id": 789,
            "customer_id": 123,
    ...
    "ticket.created": {
        ...
        "payload_schema": {
            ...
            "required": ["ticket_id", "ticket_number", "customer_id", "subject", "priority", "status"]
        },
        "sample_payload": {
            "ticket_id": 301,
    ...
    "reseller.created": {
        ...
        "payload_schema": {
            ...
            "required": ["reseller_id", "company_name", "commission_percentage", "created_at"]
        },
        "sample_payload": {
            "reseller_id": 10,
    ...
    "reseller.commission_earned": {
        ...
        "payload_schema": {
            ...
            "required": ["reseller_id", "customer_id", "commission_amount", "earned_at"]
        },
        "sample_payload": {
            "reseller_id": 10,
            "customer_id": 123,
...
class WebhookEventTrigger:
    ...
    async def trigger_event(self, event_name: str, payload: Dict[str, Any], 
                          triggered_by_user_id: int = None, 
                          triggered_by_customer_id: int = None,
                          source_ip: str = None, user_agent: str = None):
        """Trigger a webhook event"""
        from app.services.webhook_service import WebhookEventService, WebhookEventTypeService

...
class RBACService:
    ...
    def _initialize_role_permissions(self) -> Dict[UserRole, List[Permission]]:
        ...
        return {
            ...
            UserRole.ADMIN: [
                ...
                Permission.CUSTOMER_LIST, Permission.SERVICE_CREATE, Permission.SERVICE_READ,
                Permission.SERVICE_UPDATE, Permission.SERVICE_PROVISION, Permission.SERVICE_SUSPEND,
                Permission.BILLING_READ, Permission.BILLING_CREATE, Permission.BILLING_UPDATE,
                Permission.NETWORK_READ, Permission.NETWORK_MANAGE, Permission.SYSTEM_MONITOR
            ],
            
            UserRole.RESELLER: [
                Permission.CUSTOMER_CREATE, Permission.CUSTOMER_READ, Permission.CUSTOMER_UPDATE,
                Permission.CUSTOMER_LIST, Permission.SERVICE_CREATE, Permission.SERVICE_READ,
                Permission.SERVICE_UPDATE, Permission.SERVICE_PROVISION, Permission.BILLING_READ
            ],
            
            UserRole.CUSTOMER: [
                Permission.CUSTOMER_READ, Permission.SERVICE_READ, Permission.BILLING_READ
            ],
            
            UserRole.SUPPORT: [
                Permission.CUSTOMER_READ, Permission.CUSTOMER_UPDATE, Permission.SERVICE_READ,
                Permission.SERVICE_UPDATE, Permission.BILLING_READ
            ],
            
            UserRole.BILLING: [
                Permission.CUSTOMER_READ, Permission.BILLING_READ, Permission.BILLING_CREATE,
                Permission.BILLING_UPDATE, Permission.BILLING_PROCESS
            ],
            
            UserRole.TECHNICAL: [
                Permission.CUSTOMER_READ, Permission.SERVICE_READ, Permission.SERVICE_UPDATE,
                Permission.NETWORK_READ, Permission.NETWORK_MANAGE, Permission.NETWORK_CONFIGURE
            ]
        }
    ...
    def _get_owned_resource_ids(self, user: Administrator, resource_type: ResourceType) -> List[int]:
    ...
    def _filter_sensitive_data(
        ...
        try:
            ...
            sensitive_fields = {
                ResourceType.CUSTOMER: {
                    UserRole.CUSTOMER: ['password_hash', 'payment_methods', 'internal_notes'],
            ...
            fields_to_filter = sensitive_fields.get(resource_type, {}).get(user.role, [])

...
async def portal_logout(
    logout_data: CustomerPortalLogoutRequest, db: Session = Depends(get_db)
):
...
async def process_payment(
    ...
    try:
        ...
        payment = payment_service.process_payment(
            current_customer.id, payment_data.dict()
        )
...
async def get_payment_history(
    ...
    try:
        ...
        payments = payment_service.get_payment_history(
            current_customer.id, limit=limit, offset=offset
        )
...
async def create_service_request(
    ...
    try:
        ...
        service_request = service_request_service.create_service_request(
            current_customer.id, request_data.dict()
        )
...
@router.get(
    "/services/requests", response_model=List[CustomerPortalServiceRequestResponse]
)
async def get_service_requests(
    ...
    try:
        ...
        requests = service_request_service.get_customer_service_requests(
            current_customer.id, status=status
        )
...
async def get_upgrade_options(
    ...
    try:
        ...
        upgrade_options = service_request_service.get_available_upgrades(
            current_customer.id, service_id
        )
...
async def get_notifications(
    ...
    try:
        ...
        notifications = notification_service.get_customer_notifications(
            current_customer.id, unread_only=unread_only, limit=limit, offset=offset
        )
...
async def mark_notification_read(
    ...
    try:
        ...
        success = notification_service.mark_as_read(
            current_customer.id, notification_id
        )
...
async def get_account_activity(
    ...
    try:
        ...
        activities = dashboard_service._get_recent_activity(
            current_customer.id, limit=limit
        )

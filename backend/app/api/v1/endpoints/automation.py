...
from app.services.automation import AutomationService, AnsibleRunnerService
from app.models.auth.base import Administrator
from app.models.automation.infrastructure import Site, AutomationDevice, ProvisioningTask
...
async def provision_customer_service(
    ...
    try:
        ...
        logger.info(f"Admin {current_admin.username} initiated service provisioning for service {service_id}")
...
async def backup_device_config(
    ...
    try:
        ...
        logger.info(f"Admin {current_admin.username} initiated config backup for device {device_id}")

...
from app.schemas.service_management import (  # Service IP Assignment Schemas; Service Suspension Schemas; Service Alert Schemas
    ServiceAlert,
    ServiceAlertCreate,
    ServiceDashboard,
    ServiceIPAssignment,
    ServiceIPAssignmentCreate,
    ServiceStatusHistory,
    ServiceStatusHistoryCreate,
    ServiceSuspension,
    ServiceSuspensionCreate,
...
@router.post(
    "/ip-assignments",
    response_model=ServiceIPAssignment,
...
async def create_ip_assignment(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to create IP assignment: {str(e)}"
        )
...
async def list_ip_assignments(
    ...
    assignment_type: Optional[IPAssignmentType] = Query(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to list IP assignments: {str(e)}"
        )
...
async def get_ip_assignment(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to get IP assignment: {str(e)}"
        )


@router.delete(
    "/ip-assignments/{assignment_id}", status_code=status.HTTP_204_NO_CONTENT
)
async def release_ip_assignment(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to release IP assignment: {str(e)}"
        )
...
@router.post(
    "/status-history",
    response_model=ServiceStatusHistory,
    status_code=status.HTTP_201_CREATED,
)
async def create_status_history(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to create status history: {str(e)}"
        )
...
async def list_status_history(
    service_id: Optional[int] = Query(None, description="Filter by service ID"),
    new_status: Optional[ServiceStatus] = Query(
        None, description="Filter by new status"
    ),
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to list status history: {str(e)}"
        )
...
@router.post(
    "/suspensions",
    response_model=ServiceSuspension,
    status_code=status.HTTP_201_CREATED,
)
async def create_service_suspension(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to create suspension: {str(e)}"
        )
...
async def list_service_suspensions(
    service_id: Optional[int] = Query(None, description="Filter by service ID"),
    reason: Optional[SuspensionReason] = Query(
        None, description="Filter by suspension reason"
    ),
    is_active: Optional[bool] = Query(None, description="Filter by active status"),
    page: int = Query(1, ge=1, description="Page number"),
    size: int = Query(20, ge=1, le=100, description="Page size"),
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to list suspensions: {str(e)}"
        )
...
async def restore_service_suspension(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to restore suspension: {str(e)}"
        )
...
@router.post(
    "/usage-tracking",
    response_model=ServiceUsageTracking,
    status_code=status.HTTP_201_CREATED,
)
async def create_usage_tracking(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to create usage tracking: {str(e)}"
        )
...
async def list_usage_tracking(
    service_id: Optional[int] = Query(None, description="Filter by service ID"),
    metric_type: Optional[UsageMetricType] = Query(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f"Failed to list usage tracking: {str(e)}"
        )
...
@router.post(
    "/alerts", response_model=ServiceAlert, status_code=status.HTTP_201_CREATED
)

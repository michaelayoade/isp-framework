...
async def list_permissions(
    ...
    try:
        permissions = rbac_service.list_permissions(
            active_only=active_only, category=category
        )
        return permissions
...
async def create_permission(
    ...
    try:
        ...
        logger.info(
            f"Admin {current_admin.username} created permission: {permission.code}"
        )
        return permission
    except Exception as e:
...
async def update_permission(
    ...
    try:
        ...
        logger.info(
            f"Admin {current_admin.username} updated permission {permission_id}"
        )
        return permission
    except Exception as e:
...
async def delete_permission(
    ...
    try:
        ...
        logger.info(
            f"Admin {current_admin.username} deleted permission {permission_id}"
        )
    except Exception as e:
...
async def list_roles(
    ...
    try:
        roles = rbac_service.list_roles(
            active_only=active_only, include_permissions=include_permissions
        )
        return roles
    except Exception as e:
...
async def get_role(
    ...
    try:
        ...
        role_dict = {**role.__dict__, "permissions": permissions}
        return role_dict
    except Exception as e:
...
async def assign_permissions_to_role(
    ...
    try:
        role = rbac_service.assign_permissions_to_role(
            role_id, permission_update.permission_ids
        )
        logger.info(
            f"Admin {current_admin.username} updated permissions for role {role_id}"
        )
...
async def assign_role_to_user(
    ...
    try:
        ...
        logger.info(
            f"Admin {current_admin.username} assigned role {user_role_data.role_id} to user {user_id}"
        )
        return user_role
    except Exception as e:
...
async def remove_role_from_user(
    ...
    try:
        ...
        logger.info(
            f"Admin {current_admin.username} removed role {role_id} from user {user_id}"
        )
    except Exception as e:

...
async def create_customer_status(
    ...
    try:
        ...
        logger.info(
            f"Admin {current_admin.username} created customer status: {customer_status.code}"
        )
...
async def update_customer_status(
    ...
    try:
        ...
        logger.info(
            f"Admin {current_admin.username} updated customer status {status_id}"
        )
        return customer_status
    except Exception as e:
...
async def delete_customer_status(
    ...
    try:
        ...
        logger.info(
            f"Admin {current_admin.username} deleted customer status {status_id}"
        )
    except Exception as e:

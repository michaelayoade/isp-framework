...
from ....schemas.billing import (  # Invoice schemas; Payment schemas; Summary schemas
    BillingOverview,
    CreditNoteCreate,
    CreditNoteResponse,
    CreditNoteSearch,
...
async def get_overdue_invoices(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to get overdue invoices",
        )
...
async def get_invoice_payments(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to get invoice payments",
        )
...
async def get_customer_payments(
    ...
    try:
        payment_service = PaymentService(db)
        payments = payment_service.payment_repo.get_customer_payments(
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to get customer payments",
        )
...
async def search_credit_notes(
    ...
    limit: int = Query(
        100, ge=1, le=1000, description="Number of credit notes to return"
    ),
...
async def get_credit_note(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to get credit note",
        )


@router.get(
    "/invoices/{invoice_id}/credit-notes", response_model=List[CreditNoteResponse]
)
async def get_invoice_credit_notes(
    ...
    try:
        credit_note_service = CreditNoteService(db)
        credit_notes = credit_note_service.credit_note_repo.get_invoice_credit_notes(
            invoice_id
        )
        return credit_notes
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to get invoice credit notes",
        )


@router.get(
    "/customers/{customer_id}/credit-notes", response_model=List[CreditNoteResponse]
)
async def get_customer_credit_notes(
    ...
    try:
        credit_note_service = CreditNoteService(db)
        credit_notes = credit_note_service.credit_note_repo.get_customer_credit_notes(
            customer_id, limit, offset
        )
        return credit_notes
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to get customer credit notes",
        )
...
@router.get(
    "/customers/{customer_id}/billing-summary", response_model=CustomerBillingSummary
)
async def get_customer_billing_summary(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to get customer billing summary",
        )
...
async def get_billing_statistics(
    ...
    try:
        ...
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
            detail="Failed to get billing statistics",
        )

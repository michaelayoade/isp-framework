...
async def get_system_health_overview(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to retrieve system health overview")
...
async def get_error_metrics_dashboard(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to retrieve error metrics dashboard")
...
async def get_complete_operational_dashboard(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail="Failed to retrieve complete operational dashboard")
...
async def health_check_endpoint(
    ...
    try:
        ...
        response = {
            ...
            'components': {
                'dead_letter_queue': dlq_health.get('status', 'unknown')
            }
        }

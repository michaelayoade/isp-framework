...
async def create_contact_type(
    ...
    try:
        ...
        logger.info(f"Admin {current_admin.username} created contact type: {contact_type.code}")
        return contact_type
    except Exception as e:
...
async def update_contact_type(
    ...
    try:
        contact_type = contact_type_service.update_contact_type(contact_type_id, contact_type_data)
        logger.info(f"Admin {current_admin.username} updated contact type {contact_type_id}")
        return contact_type
    except Exception as e:
...
async def delete_contact_type(
    ...
    try:
        ...
        logger.info(f"Admin {current_admin.username} deleted contact type {contact_type_id}")
    except Exception as e:

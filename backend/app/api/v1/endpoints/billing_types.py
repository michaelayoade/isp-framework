...
async def create_billing_type(
    ...
    try:
        ...
        logger.info(f"Admin {current_admin.username} created billing type: {billing_type.code}")
        return billing_type
    except Exception as e:
...
async def update_billing_type(
    ...
    try:
        billing_type = billing_type_service.update_billing_type(billing_type_id, billing_type_data)
        logger.info(f"Admin {current_admin.username} updated billing type {billing_type_id}")
        return billing_type
    except Exception as e:
...
async def delete_billing_type(
    ...
    try:
        ...
        logger.info(f"Admin {current_admin.username} deleted billing type {billing_type_id}")
    except Exception as e:

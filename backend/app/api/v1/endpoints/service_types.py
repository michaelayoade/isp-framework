...
async def create_service_type(
    ...
    try:
        ...
        logger.info(
            f"Admin {current_admin.username} created service type: {service_type.code}"
        )
        return service_type
    except Exception as e:
...
async def update_service_type(
    ...
    try:
        service_type = service_type_service.update_service_type(
            service_type_id, service_type_data
        )
        logger.info(
            f"Admin {current_admin.username} updated service type {service_type_id}"
        )
        return service_type
    except Exception as e:
...
async def delete_service_type(
    ...
    try:
        ...
        logger.info(
            f"Admin {current_admin.username} deleted service type {service_type_id}"
        )
    except Exception as e:

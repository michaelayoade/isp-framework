...
class CreditNote(Base):
    ...
    def is_approved(self):
        ...
        return not self.requires_approval or (self.approved_by is not None and self.approved_date is not None)
    ...
    def apply_credit(self):
        ...
        self.billing_account.available_balance = self.billing_account.calculate_available_balance()
    ...
    def get_credit_note_summary(self):
        ...
        return {
            ...
            "service_period": {
                "start": self.service_period_start.isoformat() if self.service_period_start else None,
                "end": self.service_period_end.isoformat() if self.service_period_end else None
            }
        }
...
class CreditNoteTemplate(Base):
    ...
    # Amount calculation
    amount_type = Column(String(20), nullable=False, default="fixed")  # fixed, percentage, calculated
    ...
    def calculate_amount(self, base_amount):
        ...
        if self.amount_type == "fixed":
            ...
            amount = base_amount * (self.percentage_amount / 100) if self.percentage_amount else 0
        else:
    ...
    def get_template_summary(self):
        ...
        return {
            ...
            "percentage_amount": float(self.percentage_amount) if self.percentage_amount else None,
            "limits": {
...
class CreditNoteApproval(Base):
    ...
    requested_date = Column(DateTime(timezone=True), nullable=False, default=lambda: datetime.now(timezone.utc))

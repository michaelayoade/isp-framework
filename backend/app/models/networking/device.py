...
class Device(Base):
    ...
    mac_address = Column(String(17), nullable=False, unique=True, index=True)  # AA:BB:CC:DD:EE:FF
    name = Column(String(255), nullable=True)
    description = Column(Text, nullable=True)
    device_type = Column(String(50), nullable=True)  # router, switch, camera, sensor, etc.
    
    # Status and lifecycle
    status = Column(String(20), nullable=False, default="pending")  # pending, active, blocked, expired
    ...
    last_nas_identifier = Column(String(255), nullable=True)  # NAS that last saw this device

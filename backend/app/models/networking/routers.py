...
class Router(Base):
    ...
    status = Column(String(20), default='unknown')  # ok, api_error, error, disabled, unknown
    ...
    sectors = relationship("RouterSector", back_populates="router", cascade="all, delete-orphan")

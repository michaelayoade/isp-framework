...
class Reseller(Base):
    ...
    api_keys = relationship("APIKey", back_populates="reseller", cascade="all, delete-orphan")
...
class DeadLetterQueue(Base):
    ...
    status = Column(String(50), default='pending', index=True)  # pending, requeued, failed, processed, error

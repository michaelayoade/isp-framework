...
class CommunicationLog(Base):
    ...
    provider_id = Column(Integer, ForeignKey("communication_providers.id"), nullable=True)
...
class CommunicationQueue(Base):
    ...
    template_variables = Column(JSON, default=dict)  # Global variables for all recipients
...
class CommunicationRule(Base):
    ...
    trigger_event = Column(String(100), nullable=False)  # customer.created, invoice.overdue, etc.

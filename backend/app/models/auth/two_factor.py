...
class TwoFactorAuth(Base):
    ...
    admin_id = Column(Integer, ForeignKey("administrators.id"), unique=True, nullable=False)
    ...
    email_address = Column(String(255))  # For Email 2FA (can be different from admin email)
    ...
    locked_until = Column(DateTime(timezone=True))  # Temporary lock after failed attempts

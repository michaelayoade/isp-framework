...
# Import all enums
from .enums import (
    ServiceStatus, ServiceType, ProvisioningStatus, SuspensionReason,
    ConnectionType, IPAssignmentType, SuspensionType, ServiceCategory,
    ServiceSubcategory, QualityProfile, SupportLevel, ChangeMethod,
    BillingModel, VoiceCodec, TrafficPriority, ContentFilterLevel
)
...
from .management import (
    ...
    ServiceUsageTracking, ServiceAlert
)
...
def get_all_service_models():
    ...
    return [
        ServiceTemplate, InternetServiceTemplate, VoiceServiceTemplate,
        BundleServiceTemplate, CustomerService, CustomerInternetService,
        CustomerVoiceService, ServiceProvisioning, ProvisioningTemplate,
        ProvisioningQueue, ServiceIPAssignment, ServiceStatusHistory,
        ServiceSuspension, ServiceUsageTracking, ServiceAlert
    ]
...
def validate_service_configuration():
    ...
    models_with_relationships = [
        CustomerService, ServiceProvisioning, ServiceIPAssignment
    ]

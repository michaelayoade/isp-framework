...
class Role(Base):
    ...
    code = Column(String(50), unique=True, nullable=False, index=True)  # super_admin, billing_manager, etc.
    ...
    requires_approval = Column(Boolean, default=False)  # Does assignment require approval

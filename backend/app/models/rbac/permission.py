...
class Permission(Base):
    ...
    code = Column(String(100), unique=True, nullable=False, index=True)  # customers.view, billing.create, etc.
    name = Column(String(150), nullable=False)  # Display name
    description = Column(String(255))  # Detailed description
    category = Column(String(50), nullable=False, index=True)  # customers, billing, tickets, etc.
    ...
    action = Column(String(50), nullable=False)  # view, create, update, delete, export, etc.

...
class MikroTikDevice(Base):
    ...
    routeros_version_category = Column(Enum(RouterOSVersion), default=RouterOSVersion.UNKNOWN)
    ...
    simple_queues = relationship("MikroTikSimpleQueue", back_populates="mikrotik_device")
    firewall_rules = relationship("MikroTikFirewallRule", back_populates="mikrotik_device")
    address_lists = relationship("MikroTikAddressList", back_populates="mikrotik_device")
    pppoe_secrets = relationship("MikroTikPPPoESecret", back_populates="mikrotik_device")
    hotspot_users = relationship("MikroTikHotspotUser", back_populates="mikrotik_device")
...
class MikroTikInterface(Base):
    ...
    device_id = Column(Integer, ForeignKey("mikrotik_devices.device_id"), nullable=False)

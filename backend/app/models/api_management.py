...
class APIEndpoint(Base):
    ...
    api_version_id = Column(
        Integer, ForeignKey("api_management_versions.id"), nullable=False
    )
...
APIKey.usage_logs = relationship(
    "APIUsage", back_populates="api_key", cascade="all, delete-orphan"
)
APIKey.rate_limits = relationship(
    "APIRateLimit", back_populates="api_key", cascade="all, delete-orphan"
)
APIKey.quotas = relationship(
    "APIQuota", back_populates="api_key", cascade="all, delete-orphan"
)

APIVersion.endpoints = relationship(
    "APIEndpoint", back_populates="api_version", cascade="all, delete-orphan"
)
